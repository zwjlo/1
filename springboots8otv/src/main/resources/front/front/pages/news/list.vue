		...
		<view :style='{"padding":"0","borderColor":"#21d5ae","margin":"0","alignItems":"flex-start","display":"flex","justifyContent":"space-between","minHeight":"100vh","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20221224/7e3cf68e360446639633a87989cda19c.gif) no-repeat center bottom / 100% auto,#192231","borderWidth":"0px 0","width":"100%","position":"relative","borderStyle":"dashed","height":"auto"}'>
			...
			<view :style='{"padding":"0","margin":"0","alignItems":"flex-start","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20221224/7e3cf68e360446639633a87989cda19c.gif) no-repeat center bottom / 100% auto,#192231","display":"flex","width":"100%","height":"auto"}'>
				...
				<view class="news-box6" :style='{"width":"100%","padding":"24rpx","margin":"0","height":"auto"}'>
					<view @tap="onDetailTap(product)" v-for="(product,index) in list" :key="index" class="list-item" :style='{"padding":"8rpx 24rpx 8rpx 100rpx","margin":"0 0 20rpx","borderColor":"#67bfc7","background":"rgba(105,213,223,.1)","borderWidth":"2rpx 2rpx 4rpx","width":"100%","position":"relative","borderStyle":"dotted dashed solid double","height":"auto"}'>
					  ...
					  <view class="item-list-body" :style='{"width":"100%","margin":"0","height":"auto"}'>
						<view :style='{"padding":"8rpx 20rpx","whiteSpace":"nowrap","overflow":"hidden","color":"#35afc0","width":"100%","lineHeight":"48rpx","fontSize":"28rpx","textOverflow":"ellipsis"}' class="title ">{{product.title}}</view>
						<view :style='{"padding":"4rpx 20rpx","overflow":"hidden","color":"#4a8189","width":"100%","lineHeight":"48rpx","fontSize":"28rpx","textIndent":"2em","height":"96rpx"}' class="desc ">{{product.introduction}}</view>
					  </view>
					</view>
				</view>
