	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="举报时间" prop="jubaoshijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.jubaoshijian" label="举报时间" prop="jubaoshijian">
					<el-input v-model="ruleForm.jubaoshijian" placeholder="举报时间" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="举报内容" prop="jubaoneirong">
					<el-input
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else-if="ruleForm.jubaoneirong" label="举报内容" prop="jubaoneirong">
